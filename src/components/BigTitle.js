        ...
        <Jumbotron className="bg-transparent jumbotron-fluid p-0">
            <Container fluid={true}>
                <Row className="justify-content-center">
                    <Col className="py-5"  xl={4} lg={{ span: 4, order: 1 }} md={12} sm={12} xs={{span: 12, order: 2 }}>
                        { props.title && <h1 className="google-font display-2 font-weight-bolder">{props.title}</h1> }
                    ...
                    <Col className="p-0" xl={8} lg={{ span: 8, order: 2 }} md={12} sm={12} xs={{span: 12, order: 1 }}>
